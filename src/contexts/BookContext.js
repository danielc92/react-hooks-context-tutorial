...
const BookContextProvider = (props) => {
  ...
  const [books, setBooks] = useState([
    {
      ...
      "language": "English",
      "link": "https://en.wikipedia.org/wiki/The_Life_and_Opinions_of_Tristram_Shandy,_Gentlema" +
          "n\n",
      "pages": 640,
  ...
  const addBook = (title, author, country) => {
    const newBook = {title, author, country, id: uuidv4()}
